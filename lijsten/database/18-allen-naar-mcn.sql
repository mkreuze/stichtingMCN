-- ============================================================
--  "Allen" wordt: hele organisatie MCN
--
--  Acties met de losse naam "Allen" krijgen als actiehouder de hele
...
where  o.eigen
  ...
  and  lower(btrim(a.eigenaar)) = 'allen';

-- ── Controle ────────────────────────────────────────────────
-- Bovenaan de acties die nu bij de hele organisatie staan. Staat er
-- onderaan nog een regel met "Allen", dan is het niet gelukt; kijk dan
...
union all
select 'nog Allen', '', a.titel
from   acties a
where  lower(btrim(a.eigenaar)) = 'allen' and a.eigenaar_organisatie_id is null
order  by 1, 3;
